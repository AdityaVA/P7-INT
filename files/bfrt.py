...
vlan_fwd = p4p7.SwitchIngress.vlan_fwd
vlan_fwd.add_with_match(vid=1920, ingress_port=132,   link=2)
...
arp_fwd = p4p7.SwitchIngress.arp_fwd
arp_fwd.add_with_match_arp(vid=1920, ingress_port=132,   link=2)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=5, dest_ip=IPAddress('10.0.2.2'),   link_id=1, sw_id=3)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=5, dest_ip=IPAddress('10.0.1.1'),   link_id=4, sw_id=2)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=4, dest_ip=IPAddress('10.0.2.2'),   link_id=5, sw_id=2)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=4, dest_ip=IPAddress('10.0.1.1'),   link_id=3, sw_id=1)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=3, dest_ip=IPAddress('10.0.2.2'),   link_id=4, sw_id=1)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=3, dest_ip=IPAddress('10.0.1.1'),   link_id=0, sw_id=0)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send(sw=1, dest_ip=IPAddress('10.0.2.2'),   port=128)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=1, dest_ip=IPAddress('10.0.1.1'),   link_id=5, sw_id=3)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send(sw=0, dest_ip=IPAddress('10.0.1.1'),   port=136)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=0, dest_ip=IPAddress('10.0.2.2'),   link_id=3, sw_id=0)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=5, dest_ip=IPAddress('10.0.0.254'),   link_id=2, sw_id=3)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=4, dest_ip=IPAddress('10.0.0.254'),   link_id=5, sw_id=2)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=3, dest_ip=IPAddress('10.0.0.254'),   link_id=4, sw_id=1)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send(sw=2, dest_ip=IPAddress('10.0.0.254'),   port=132)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=2, dest_ip=IPAddress('10.0.1.1'),   link_id=5, sw_id=3)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=0, dest_ip=IPAddress('10.0.0.254'),   link_id=3, sw_id=0)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=2, dest_ip=IPAddress('10.0.2.2'),   link_id=1, sw_id=3)

basic_fwd = p4p7.SwitchIngress.basic_fwd
basic_fwd.add_with_send_next(sw=1, dest_ip=IPAddress('10.0.0.254'),   link_id=2, sw_id=3)
...
Int_source = p4user.Ingress.Int_source.tb_int_source
# Int_source.mod_with_configure_source(srcAddr=IPAddress("10.0.3.3"),
#                     srcAddr_mask=0xFFFFFFFF,
...
Int_transit.add_with_configure_transit(switch_id=1, l3_mtu=1500, sw_id= 0)
Int_transit = p4user.Egress.Int_transit.tb_int_transit
Int_transit.add_with_configure_transit(switch_id=2, l3_mtu=1500, sw_id= 1)
Int_transit = p4user.Egress.Int_transit.tb_int_transit
Int_transit.add_with_configure_transit(switch_id=3, l3_mtu=1500, sw_id= 2)
